...
Record the version in your analysis script; for an unreleased GitHub install, also record the commit SHA and pin that SHA when you return. A classification image is only reproducible against the exact code that computed it.
