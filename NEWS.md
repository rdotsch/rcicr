...
- **Stimulus sets generated by 1.0.1 and 1.1.0 are now covered by tests.** The suite carries
  ...
  classification image, and that `generateReferenceDistribution2IFC()` carries a 1.0.1 file
  (which predates `nscales` and `sigma`) through to a usable null distribution. Every other
